...
namespace Lykke.Service.HFT.Core.Services
{
    public interface IMatchingEngineAdapter
    {
        ...
        Task<ResponseModel<double>> HandleMarketOrderAsync(string clientId, string assetPairId, double volume, bool straight, double? reservedLimitVolume = default(double?));
