...
namespace Lykke.Service.HFT.Core.Services
{
    public interface IMatchingEngineAdapter
    {
        ...
        Task<ResponseModel<Guid>> HandleMarketOrderAsync(string clientId, string assetPairId, OrderAction orderAction, double volume, bool straight, double? reservedLimitVolume = default(double?));
